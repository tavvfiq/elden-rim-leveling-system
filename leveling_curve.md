# Elden Ring: Rune Leveling Cost Formula
...
To calculate exactly how many Runes you need to move from your **current level (L)** to your **next level**, the game engine runs your current level through a two-part formula. 
...
### Example A: Moving from Level 10 to Level 11
...
### Example B: Moving from Level 12 to Level 13
